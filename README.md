# nvim-treesitter-queries-nu

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-nu/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-nu/actions/workflows/validate.yml)

Neovim tree-sitter queries for **nu**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-nu",
...
- [ ] Changes are scoped to `nu` — do not include files for other languages
